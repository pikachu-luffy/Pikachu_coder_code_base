...
def enrich_csv_with_bot_id_and_mdlz_id(blob: str, bot_prefix: str, context) -> str:
    try:
        ...
        for chunk in chunks:
            ...
            output_loaded_rows = load_dataframe_to_bigquery(chunk, context)
            total_rows_loaded += output_loaded_rows
    ...
    try:
        ...
        for each_bot_prefix in bot_id_prefix_list:
            ...
            for blob_info in blob_list:
                ...
                load_error_message = None
                try:
                    total_rows_loaded, file_load_status, load_error_message = enrich_csv_with_bot_id_and_mdlz_id(blob, each_bot_prefix, context)
